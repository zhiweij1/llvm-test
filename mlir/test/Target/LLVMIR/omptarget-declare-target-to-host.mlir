...
module attributes {llvm.target_triple = "x86_64-unknown-linux-gnu", omp.is_gpu = false, omp.is_target_device = false, omp.target_triples = ["amdgcn-amd-amdhsa"]} {
  ...
  // CHECK-DAG: @.offloading.entry._QMtest_0Ezii = weak constant %struct.__tgt_offload_entry { ptr @_QMtest_0Ezii, ptr @.offloading.entry_name, i64 44, i32 0, i32 0 }, section "omp_offloading_entries", align 1
